...
Slides from today are available [here](https://docs.google.com/presentation/d/1t-3-WkeSneBdBkzjilMZUxHEUFas896azLErI8eplUw/edit?usp=sharing).
...
- When everyone is ready, discuss the prompts below. One of you volunteer to record a few thoughts in [this Google Doc](https://docs.google.com/document/d/1in6FDQ2hwjVW9rVLzzpC0l9Ldv-CnfsokSGfTg7fMkw/edit?usp=sharing). The instructor will summarize responses from all the sections to create a resource that everyone can use.
